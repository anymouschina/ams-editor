...
export const getChartData = ams.createApiAction({
    getOptions (params) {
        const key = this.resource.key;
        let value = _getValue.call(this, key, params);
        if (typeof this.resource.api.getChartData === 'object') {
            return _getSendData(
                this.resource.api.getChartData,
                'get',
        ...
        return {
            url: `${this.resource.api.getChartData}`,
...
export const delete_reseful = ams.createApiAction({
    getOptions (params) {
        const key = this.resource.key;
        let value = _getValue.call(this, key, params);
        ...
        if (typeof this.resource.api.delete === 'object') {
            return _getSendData(
                this.resource.api.delete_reseful,
                'delete',
                this.resource.api.prefix,
                {
                    [key]: value,
        ...
        // 支持传参数
        return {
            url: `${this.resource.api.delete_reseful}`,
            method: this.resource.api.method || 'delete',
            params: {
                [key]: value,
                // resId: this.block.resource,
                ..._getForeignKeys.call(this, params)
...
export const list = ams.createApiAction({
    getOptions(params) {
        ...
        console.info(this.resource.api,'api')
        return {
            url: `${this.resource.api.list}`,
            method: this.resource.api.method || 'get',
            params: arg
        };
    },
