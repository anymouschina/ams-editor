import { serialize, deepExtend, dealUrl } from '../utils';
...
export default function initRequest (ams) {
    ...
    */
    ams.request = function (options, target) {
        // const that = target;//当前发起请求的作用域
        const that = this;
        return new Promise(async (resolve, reject) => {
            ...
            console.info(that.$ams, 'request instance====>')
    ...
    ams.createApiAction = function (options) {
        ...
        return async function (params = {}) {
            ...
            try {
                ...
                const res = await ams.request.call(this, requestOptions);
